...
| Eng → Entrega | Diff / PR ref + residual risk | Ship checklist or bounce |
...
No silent hop. If Eng finishes and Entrega starts without a card update, that is a bug in the docs or the host mapping.
